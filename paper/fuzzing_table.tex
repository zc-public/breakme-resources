...
ACTIVE/AUTHENTICATED & \texttt{A2}+CRC                     & silent          &                                             \\
ACTIVE/AUTHENTICATED & \textbf{\texttt{**}+CRC}            & \textbf{silent} &                                             \\
ACTIVE/AUTHENTICATED & \textbf{\texttt{1A00}} / \textbf{\texttt{1A00**}} & \textbf{reply}  & \textbf{variant 1: $\rightarrow$ 
 \texttt{AF}$\|$E(RndB), wrong CRC, $\Delta:$~\texttt{0x6CF3}}              \\
ACTIVE               & \textbf{\texttt{1A00}} / \textbf{\texttt{1A00**}} & \textbf{reply}  & \textbf{variant 2: $\rightarrow$ 
 \texttt{AF}$\|$E(RndB), wrong CRC, $\Delta:$~\texttt{0xB4C5}}              \\
...
ACTIVE/AUTHENTICATED & \texttt{A2**}                       & silent          &                                             \\
ACTIVE/AUTHENTICATED & \textbf{\texttt{****}}              & \textbf{silent} &                                             \\
ACTIVE               & \texttt{1A00}+CRC\textbf{(+**\dots)}                   & reply           & AUTHENTICATE \textbf{(optionally with spurious bytes)}                               \\
AUTHENTICATED        & \textbf{\texttt{1A00}+CRC(+**\dots)}          & \textbf{reply}  & \textbf{variant 1: $\rightarrow$ 
 \texttt{AF}$\|$E(RndB)}              \\
