...
These operations have been successfully tested with a Proxmark3 RDV4 against both Ultralight~C and Ultralight~AES tags, using Android phones and hospitality readers as the authenticating reader.
