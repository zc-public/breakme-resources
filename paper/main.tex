...
\begin{table}[ht]
  ...
  \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \makecell[tl]{{\small \texttt{hf mfu cauth/aesauth}}\\{\small \texttt{--retries/--nocheck/--read0}}\\{\small \texttt{--collect/--pair}}} & New options to support optimizations described in Sections~\ref{sec:tearing_calibration} and~\ref{sec:aes_tearing} and authentication with colliding nonces as described in Section~\ref{sec:counterfeit_recovery}\\ \hline
