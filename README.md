...
A local copy of the paper is available [here](paper/deliverables/20260120_eprint_rev1.pdf).

| Directory   | Description                          |
|-------------|--------------------------------------|
| [`cards`](cards)      | Data on various cards, see details [here](cards/README.md)|
| [`flipper_apps`](flipper_apps) | Flipper Zero apps implementing select attacks, see details [here](flipper_apps/README.md)|
| [`paper`](paper)      | LaTeX source files of the paper    |
| [`tools`](tools)      | Other helpful scripts for manual testing |
